========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : WIVER
========================================================================


Diese WIVER-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\WIVER.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei WIVER.rc eingebunden.
...
WIVERDlg.h, WIVERDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CWIVERDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in WIVER.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	WIVER.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
